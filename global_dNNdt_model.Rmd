...
test_dataframe1$global_dNNdt_predicted1 <- global_dNNdt2(education_variable = education_data1, 
...
ggplot(test_dataframe1, aes(x = education_data1, y= global_dNNdt_predicted1)) +
  geom_point() +
  labs(x = "Global Average Years of Education", y = "Predicted Global dN/Ndt")
```
